...
# Les mêmes opérations peuvent être faites en R-base, mais il faut alors combiner quelques fonctions:
# sapply(regmatches(tableau_synthese$texte, gregexpr("[[:alpha:]]+", tableau_synthese$texte)), length)
# sapply(regmatches(tableau_synthese$texte, gregexpr("\\w+[.?!]", tableau_synthese$texte)), length)
